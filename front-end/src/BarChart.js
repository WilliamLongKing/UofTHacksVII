...
//   //     .enter()
//   //     .append("rect")
//   //     .attr("x", function(d, i) { console.log(i); console.log(d[0]); console.log(d[0].data.year); return x(formatYear(d[i].data.year));})
//   //     .attr("y", function(d, i) { console.log(y(d[0][i])); return y(d[0][0]); })
//   //     .attr("height", function(d, i) { return -(y(d[0][1]) - y(d[0][0])); })
